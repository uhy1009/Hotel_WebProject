		...
		<form action="login.do" method="post">
			<table>
				...
				<tr align="center" height="80px">
					<td>
					<input type="text" name="id" placeholder="<spring:message code="message.user.login.id"/>" required autofocus class="form-control"
					 	   style="width: 300px; height: 50px;"/>
					</td>
				</tr>
				<tr align="center">
					<td>
					<input type="password" name="password" placeholder="<spring:message code="message.user.login.password"/>" required class="form-control"
					 	   style="width: 300px; height: 50px;"/>
					</td>	
				</tr>
				<tr align="center" height="80px">
					...
					<input type="submit" value=<spring:message code='message.user.login.loginBtn'/> class="form-control"
