	...
	<h1>관리자</h1>
		<form action="j_security_check" method="post">
			...
			<tr align="center">
				...
				<tr height="80px">
					<td>
					<input type="text" name='j_username' placeholder="아이디" required autofocus class="form-control"
					 	   style="width: 300px; height: 50px;"/>
					</td>
				</tr>
				<tr>
					<td>
					<input type="password" name='j_password' placeholder="비밀번호" required class="form-control"
					 	   style="width: 300px; height: 50px;"/>
					</td>	
				</tr>
				<tr height="80px">
					<td style="border-bottom: #f8f7f9; border-bottom-style: inset;">
					<input type="submit" id="checkId" value="로그인" class="form-control"
					 	   style="width: 300px; height: 50px;"/>
					</td>
				</tr>
			</table>
